...
pregnancy_boxplot <- com %>% group_by(`Serial Number`) %>% summarise(n = n(), name = 'Number of gestations') %>% ggplot(aes(name, n)) + geom_boxplot() + labs(x = "", y = "") + scale_y_continuous(breaks = seq(1,10,by=2))
